        ...
        <div className="mx-auto w-full px-2 sm:px-6 lg:px-8">
          <div className="relative flex h-16 items-center justify-between">
            ...
            <div className="hidden sm:block">
              <a href="/profile" className="" title="Profile">
              <div className={userDetails ? "flex items-center" : "hidden"}>
                <div className="flex-shrink-0">
                  <Avatar src={userDetails?.avatarUrl} initials={userDetails?.displayName} alt={userDetails?.firstName + ' ' + userDetails?.lastName} />
                </div>
                <div className="ml-3">
